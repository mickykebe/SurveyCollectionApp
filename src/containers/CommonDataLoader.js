...
import { fetchCurrenciesSuccess, fetchLanguagesSuccess, commonDataLoaded } from '../actions';
import api from '../api';
...
class CommonDataLoader extends Component {
  ...
  fetchData = () => {
    ...
    Promise
      .all([api.Languages.all(), api.Currencies.all()])
      .then((responses) => {
      ...
      .catch(e => console.log(e) || this.setState({ loading: false, errors: e}));
  }
